...
export const defaultTheme = {
  theme: {
    ...
    palette: {
      mode: process.env.NEXT_PUBLIC_NX_THEME_MODE,
      background: {
        paper: '#fff',
        default: '#F4F7FE',
      },
      primary: {
        main: process.env.NEXT_PUBLIC_NX_PRIMARY_COLOR,
        contrastText: '#fff',
      },
      secondary: {
        main: process.env.NEXT_PUBLIC_NX_SECONDARY_COLOR,
      },
      success: {
        main: '#11C15B',
        light: '#D9F5E5',
...
const defaultConfig = {
  sidebar: {
    borderColor: '#757575',
    menuStyle: process.env.NEXT_PUBLIC_NX_MENU_STYLE || MenuStyle.DEFAULT,
    allowSidebarBgImage: process.env.NEXT_PUBLIC_NX_ALLOW_SIDEBAR_IMAGE || false,
    sidebarBgImageId: process.env.NEXT_PUBLIC_NX_SIDEBAR_IMAGE_ID || 1,
    colorSet: UserSidebar,
  },
  themeStyle: ThemeStyle.STANDARD,
  themeMode: process.env.NEXT_PUBLIC_NX_THEME_MODE,
  navStyle: process.env.NEXT_PUBLIC_NX_NAV_STYLE || 'default',
  layoutType: process.env.NEXT_PUBLIC_NX_LAYOUT_TYPE,
